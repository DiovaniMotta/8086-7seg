...
; ROTINA QUE MOSTRA A MENSAGEM APONTADA PARA BX   
MOSTRAR_BX:
   MOV AL, [BX]
   CMP AL, 0
   JE FIM_MOSTRAR_BX ; FICA AGUARDANDO
   CALL MANDA_CARACTER ; ENVIA PARA O TERMINAL
...
; ROTINA QUE FICA AGUARDANO O RETORNO DO TERMINAL   
RETORNO:
   RET
...
;  COMPARA SE A HORA DO RELOGIO E OS VALOR CONTIDO NO DESPERTADOR   
COMP_HOR_UNI:
   MOV AL, HOR_UNI
   CMP AL, HOR_UNI_DES
   JE COMP_MIN_DEZ
...
;  COMPARA SE OS MINUTOS DO RELOGIO E OS VALOR CONTIDO NO DESPERTADOR   
COMP_MIN_DEZ:
   MOV AL, MIN_DEZ
   CMP AL, MIN_DEZ_DES
   JE COMP_MIN_UNI
...
;  COMPARA SE OS SEGUNDOS DO RELOGIO E OS VALOR CONTIDO NO DESPERTADOR   
COMP_SEG_DEZ:
   MOV AL, SEG_DEZ
   CMP AL, SEG_DEZ_DES
   JE COMP_SEG_UNI
...
COMP_SEG_UNI:
   MOV AL, SEG_UNI
   CMP AL, SEG_UNI_DES
   JE DESPERTAR ;INVOCA A ROTINA PARA DESPERTAR(BEEP) DO REL
   RET

; ROTINA RESPONSAVEL POR EXECUTAR O BEEP DO DESPERTADOR   
DESPERTAR:
   LEA BX, MSG_DESPERTADOR
   CALL MOSTRAR_BX
   MACRO_INICIALIZA_8253_TIMER0 00H,0BFH ; INICIALIZA O BEEP
   RET
